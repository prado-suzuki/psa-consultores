...
> = {
  ...
  levantamentoPisCofins: {
    ...
    subtitle: "Escolha a ferramenta de cadastro de regras, apuração, análise cruzada e revisão de registros.",
    heroEyebrow: "",
    ...
    options: [
      ...
      },
      {
        ...
        title: "Revisão de Registros da Escrituração Fiscal Digital das Contribuições (EFD Contribuições)",
      },
    ],
  },
  analiseIcms: {
    ...
    subtitle: "Ferramentas para análise do ICMS das saídas e para análise do diferencial de alíquota (DIFAL).",
    heroEyebrow: "",
  ...
  perdcomp: {
    ...
    landingSopUrl: "https://alexandresilva-psa.github.io/Manuais_Ferramentas_PSA/",
    title: "PEDIDO ELETRÔNICO DE RESTITUIÇÃO, RESSARCIMENTO OU REEMBOLSO E DECLARAÇÃO DE COMPENSAÇÃO (PERDCOMP)",
