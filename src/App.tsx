...
const PlanejamentoTributarioHub = lazy(
  () => import('./pages/equipe/dev/PlanejamentoTributarioHub'),
);
...
const FiscalGerencialChamadosDashboard = lazy(
  () => import('./pages/equipe/fiscal/FiscalGerencialChamadosDashboard'),
);
const FiscalGerencialChamadoDetalhe = lazy(
  () => import('./pages/equipe/fiscal/FiscalGerencialChamadoDetalhe'),
);
const OsgGerencialChamados = lazy(() => import('./pages/equipe/osg/OsgGerencialChamados'));
const OsgGerencialChamadosDashboard = lazy(
  () => import('./pages/equipe/osg/OsgGerencialChamadosDashboard'),
);
const OsgGerencialChamadoDetalhe = lazy(
  () => import('./pages/equipe/osg/OsgGerencialChamadoDetalhe'),
);
...
const BoardDashboardClientesOs = lazy(
  () => import('./pages/equipe/board/BoardDashboardClientesOs'),
);
...
const DashboardUsoEnvioGerencial = lazy(
  () => import('./pages/equipe/board/DashboardUsoEnvioGerencial'),
);
...
const DesempenhoVisaoGeral = lazy(
  () => import('./pages/gerencial/desempenho/DesempenhoVisaoGeral'),
);
...
const DesempenhoReunioes1a1 = lazy(
  () => import('./pages/gerencial/desempenho/DesempenhoReunioes1a1'),
);
...
const DesempenhoRelatorios = lazy(
  () => import('./pages/gerencial/desempenho/DesempenhoRelatorios'),
);
const MinhaEvolucao = lazy(() => import('./pages/gerencial/desempenho/MinhaEvolucao'));

// Gerencial > Performance
const PerformanceDashboard = lazy(
  () => import('./pages/gerencial/performance/PerformanceDashboard'),
);
        ...
        <BrowserRouter>
          <AuthProvider>
            ...
            <AreaThemeProvider>
                ...
                <Suspense fallback={<PageLoader />}>
                  <Routes>
                    ...
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/chamados">
                          <EquipeChamados />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/chamados/:id"
                      element={
                        <PageAccessGate pagePath="/equipe/chamados">
                          <EquipeDetalhesChamado />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dashboard">
                          <EquipeDashboard />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/dashboards"
                      element={
                        <PageAccessGate pagePath="/equipe/dashboard">
                          <Dashboards />
                        </PageAccessGate>
                    ...
                    />
                    <Route
                      path="/equipe/dashboards/analise-inteligente"
                      element={
                        <PageAccessGate pagePath="/equipe/dashboard">
                          <AnaliseInteligente />
                        </PageAccessGate>
                    ...
                    />
                    <Route
                      path="/equipe/relatorios"
                      element={
                        <PageAccessGate pagePath="/equipe/relatorios">
                          <EquipeRelatorios />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/kanban"
                      element={
                        <PageAccessGate pagePath="/equipe/kanban">
                          <EquipeKanban />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/sprints"
                      element={
                        <PageAccessGate pagePath="/equipe/sprints">
                          <EquipeSprints />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/sprints/:id"
                      element={
                        <PageAccessGate pagePath="/equipe/sprints">
                          <EquipeSprintDetalhes />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/daily"
                      element={
                        <PageAccessGate pagePath="/equipe/daily">
                          <EquipeDaily />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/rotinas"
                      element={
                        <PageAccessGate pagePath="/equipe/rotinas">
                          <EquipeRotinas />
                        </PageAccessGate>
                      }
                    />
                  ...
                  migração delegável. */}
                    <Route
                      path="/equipe/tarefas"
                      element={<Navigate to="/equipe/kanban" replace />}
                    />
                    <Route
                      path="/equipe/tarefas/nova"
                      element={<Navigate to="/equipe/kanban" replace />}
                    />

                    <Route
                      path="/equipe/mapeamento"
                      element={
                        <PageAccessGate pagePath="/equipe/mapeamento">
                          <EquipeMapeamento />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/processos"
                      element={
                        <PageAccessGate pagePath="/equipe/processos">
                          <EquipeProcessos />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/projetos">
                          <EquipeProjetos />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/biblioteca"
                      element={
                        <PageAccessGate pagePath="/equipe/biblioteca">
                          <EquipeBiblioteca />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/backlog"
                      element={
                        <PageAccessGate pagePath="/equipe/backlog">
                          <EquipeBacklog />
                        </PageAccessGate>
                      }
                    />
                    ...
                    <Route
                      path="/equipe/dev"
                      element={
                        <PageAccessGate pagePath="/equipe/dev">
                          <DevDashboard />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/dev/nova-ferramenta"
                      element={
                        <PageAccessGate pagePath="/equipe/dev/nova-ferramenta">
                          <NovaFerramenta />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/dev/ferramenta/:id"
                      element={
                        <PageAccessGate pagePath="/equipe/dev/ferramenta">
                          <DetalheFerramenta />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/consulta-xmls">
                          <ConsultaXMLs />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/dev/planejamento-tributario"
                      element={
                        <PageAccessGate pagePath="/equipe/dev/planejamento-tributario">
                          <PlanejamentoTributarioHub />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/planejamento-tributario/papel-de-trabalho">
                          <PapelDeTrabalho />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/dev/consulta-sped"
                      element={
                        <PageAccessGate pagePath="/equipe/dev/consulta-sped">
                          <ConsultaSpedHub />
                        </PageAccessGate>
                      }
                    />
                    ...
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/consulta-efd-icms">
                          <ConsultaEFDICMS />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/consulta-ecd">
                          <ConsultaECD />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/consulta-ecf">
                          <ConsultaECF />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/gerenciar-dados">
                          <GerenciarDadosHub />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/carregar-dados">
                          <GerenciarDados />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/gerenciar-dados/dashboards">
                          <GerenciarDadosDashboards />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/dev/levantamento-pis-cofins"
                      element={
                        <PageAccessGate pagePath="/equipe/dev/levantamento-pis-cofins">
                          <LevantamentoPisCofinsHub />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/dev/perdcomp"
                      element={
                        <PageAccessGate pagePath="/equipe/dev/perdcomp">
                          <PerdcompHub />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/perdcomp/dashboard">
                          <PerdcompDashboard />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/dev/analise-icms"
                      element={
                        <PageAccessGate pagePath="/equipe/dev/analise-icms">
                          <AnaliseIcmsHub />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/processo-difal">
                          <ProcessoDifal />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/controle-perdcomp">
                          <ControlePerdcomp />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/controle-balancetes">
                          <ControleBalancetes />
                        </PageAccessGate>
                      }
                    />
                    ...
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/gestao-clientes">
                          <GestaoClientes />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/calculadora-ibs-cbs">
                          <CalculadoraIbsCbs />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/apuracao-pis-cofins">
                          <ApuracaoPisCofins />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/mapa-ncm-pis-cofins">
                          <MapaNCMPisCofins />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/cruzamento-dados">
                          <AuditoriaCruzada />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/correcoes-sped">
                          <CorrecoesSped />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/dev/procedimentos"
                      element={
                        <PageAccessGate pagePath="/equipe/dev/procedimentos">
                          <ProcedimentosDev />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/dev/apuracao-difal/icms-saidas">
                          <IcmsSaidas />
                        </PageAccessGate>
                      }
                    />
                  ...
                  é o comportamento correto agora. */}
                    <Route
                      ...
                      element={<Navigate to="/equipe/tax/gerencial/chamados" replace />}
                    />
                    <Route
                      path="/gestao/chamados/dashboard"
                      element={<Navigate to="/equipe/tax/gerencial/chamados/dashboard" replace />}
                    />
                    <Route path="/gestao/chamados/:id" element={<RedirecionaChamadoAntigo />} />
                    <Route
                      path="/gestao/contatos"
                      element={
                        <GestaoAccessGate>
                          <GestaoContatos />
                        </GestaoAccessGate>
                    ...
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/tax/dashboard">
                          <FiscalDashboard />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/tax/projetos/clientes">
                          <FiscalCadastrosClientes />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/tax/projetos/cadastro">
                          <FiscalProjetosCadastro />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/tax/projetos/cadastro-lote"
                      element={
                        <PageAccessGate pagePath="/equipe/tax/projetos/cadastro-lote">
                          <FiscalProjetosLote />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/tax/projetos/tarefas">
                          <FiscalDemandasTarefas />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/tax/projetos/feed">
                          <FiscalFeed />
                        </PageAccessGate>
                      }
                    />
                  ...
                  /gestao/chamados exigia. */}
                    <Route
                      ...
                      element={
                        <LiderRoute>
                          <PageAccessGate pagePath="/equipe/tax/gerencial/chamados">
                            <FiscalGerencialChamados />
                          </PageAccessGate>
                        </LiderRoute>
                      }
                    />
                    ...
                    <Route
                      ...
                      element={
                        <LiderRoute>
                          <PageAccessGate pagePath="/equipe/tax/gerencial/chamados/dashboard">
                            <FiscalGerencialChamadosDashboard />
                          </PageAccessGate>
                        </LiderRoute>
                      }
                    />
                  ...
                  cadastra, e quem pode ver a lista pode abrir um item dela. */}
                    <Route
                      path="/equipe/tax/gerencial/chamados/:id"
                      element={
                        <LiderRoute>
                          <PageAccessGate pagePath="/equipe/tax/gerencial/chamados">
                            <FiscalGerencialChamadoDetalhe />
                          </PageAccessGate>
                        </LiderRoute>
                      }
                    />
                  ...
                  O endereço antigo redireciona para não quebrar link salvo. */}
                    <Route
                      ...
                      element={
                        <LiderRoute>
                          <PageAccessGate pagePath="/equipe/tax/gerencial/logs-equipe">
                            <FiscalAuditoria />
                          </PageAccessGate>
                        </LiderRoute>
                      }
                    ...
                    <Route
                      ...
                      element={<Navigate to="/equipe/tax/gerencial/logs-equipe" replace />}
                    />
                    ...
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/osg/dashboard">
                          <OsgDashboard />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/osg/projetos/clientes">
                          <OsgClientes />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/osg/projetos/cadastro">
                          <OsgProjetos />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/osg/projetos/cadastro-lote"
                      element={
                        <PageAccessGate pagePath="/equipe/osg/projetos/cadastro-lote">
                          <OsgProjetosLote />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      ...
                      element={
                        <PageAccessGate pagePath="/equipe/osg/projetos/tarefas">
                          <OsgTarefas />
                        </PageAccessGate>
                      }
                    />
                    <Route
                      path="/equipe/osg/projetos/feed"
                      element={
                        <PageAccessGate pagePath="/equipe/osg/projetos/feed">
                          <OsgFeed />
                        </PageAccessGate>
                      }
                    />
                    ...
                    >
                      <Route
                        ...
                        element={
                          <PageAccessGate pagePath="/equipe/osg/work">
                            <OsgWorkDashboard />
                          </PageAccessGate>
                        }
                      />
                      <Route
                        ...
                        element={
                          <PageAccessGate pagePath="/equipe/osg/work/onboarding">
                            <Onboarding />
                          </PageAccessGate>
                        }
                      />
                      ...
                      <Route
                        ...
                        element={
                          <PageAccessGate pagePath="/equipe/osg/work/qualificacao-das-partes">
                      ...
                      <Route
                        ...
                        element={
                          <PageAccessGate pagePath="/equipe/osg/work/diagnostico-patrimonial">
                      ...
                      <Route
                        ...
                        element={
                          <PageAccessGate pagePath="/equipe/osg/work/controle-matriculas">
                            <ControleMatriculas />
                          </PageAccessGate>
                        }
                      />
                      <Route
                        ...
                        element={
                          <PageAccessGate pagePath="/equipe/osg/work/governanca/orgaos">
                            <OrgaosGovernanca />
                          </PageAccessGate>
                        }
                      />
                      ...
                      <Route
                        ...
                        element={
                          <PageAccessGate pagePath="/equipe/osg/work/quadro-societario">
                            <QuadroSocietario />
                          </PageAccessGate>
                        }
                      />
                      <Route
                        ...
                        element={
                          <PageAccessGate pagePath="/equipe/osg/work/calculadora-itcmd">
                            <CalculadoraItcmd />
                          </PageAccessGate>
                        }
                      />
                  ...
                  nasce vazia: não há chamado com cluster OSG. */}
                    <Route
                      path="/equipe/osg/gerencial/chamados"
                      element={
                        <LiderRoute fallbackPath="/equipe/osg">
                          <PageAccessGate pagePath="/equipe/osg/gerencial/chamados">
                            <OsgGerencialChamados />
                          </PageAccessGate>
                        </LiderRoute>
                      }
                    />
                    <Route
                      ...
                      element={
                        <LiderRoute fallbackPath="/equipe/osg">
                          <PageAccessGate pagePath="/equipe/osg/gerencial/chamados/dashboard">
                            <OsgGerencialChamadosDashboard />
                          </PageAccessGate>
                        </LiderRoute>
                      }
                    />
                    <Route
                      path="/equipe/osg/gerencial/chamados/:id"
                      element={
                        <LiderRoute fallbackPath="/equipe/osg">
                          <PageAccessGate pagePath="/equipe/osg/gerencial/chamados">
                            <OsgGerencialChamadoDetalhe />
                          </PageAccessGate>
                        </LiderRoute>
                      }
                    />
                    ...
                    <Route
                      ...
                      element={
                        <LiderRoute fallbackPath="/equipe/osg">
                          <PageAccessGate pagePath="/equipe/osg/gerencial/logs-equipe">
                            <OsgAuditoria />
                          </PageAccessGate>
                        </LiderRoute>
                      }
                    ...
                    <Route
                      ...
                      element={<Navigate to="/equipe/osg/gerencial/logs-equipe" replace />}
                    />
                  ...
                  apontavam para /equipe/board, que caía no NotFound. */}
                      <Route
                        path="/equipe/board"
                        element={<Navigate to="/equipe/board/dashboard" replace />}
                      />
                      <Route
                        path="/equipe/board/dashboard"
                        element={
              ...
              */}
                      <Route
                        path="/equipe/board/uso-envio"
                        element={
                          <PageAccessGate pagePath="/equipe/board/uso-envio">
                            <DashboardUsoEnvioGerencial />
                          </PageAccessGate>
                        }
                      />
                      <Route
                        path="/equipe/board/dashboard-clientes-os"
                        element={
                          <PageAccessGate pagePath="/equipe/board/dashboard-clientes-os">
                            <BoardDashboardClientesOs />
                          </PageAccessGate>
                        }
                      />
                      <Route
                        path="/equipe/board/clientes"
                        element={
                          <PageAccessGate pagePath="/equipe/board/clientes">
                            <BoardClientes />
                          </PageAccessGate>
                        }
                      />
                  ...
                  `fallbackPath` é a home do portal: quem não é líder+ não tem Board. */}
                      <Route
                        path="/equipe/board/chamados"
                        element={
                          <LiderRoute fallbackPath="/equipe">
                            <PageAccessGate pagePath="/equipe/board/chamados">
                              <BoardChamados />
                            </PageAccessGate>
                          </LiderRoute>
                        }
              ...
              */}
                  ...
                  mesmo motivo das originais: é leitura sobre o time todo. */}
                      <Route
                        path="/equipe/board/capacidade"
                        element={
                          <LiderRoute fallbackPath="/equipe">
                            <PageAccessGate pagePath="/equipe/board/capacidade">
                              <BoardCapacidade />
                            </PageAccessGate>
                          </LiderRoute>
                        }
                      />
                      <Route
                        path="/equipe/board/logs-equipe"
                        element={
                          <LiderRoute fallbackPath="/equipe">
                            <PageAccessGate pagePath="/equipe/board/logs-equipe">
                              <BoardLogsEquipe />
                            </PageAccessGate>
                          </LiderRoute>
                        }
                  ...
                  faixa de KPIs, navegam para aqui como detalhe. */}
                      ...
                      />
                      <Route
                        path="/equipe/board/desempenho"
                        element={
                          <DesempenhoAccessGate>
                            <DesempenhoVisaoGeral />
                          </DesempenhoAccessGate>
                        }
                      />
                      <Route
                        path="/equipe/board/desempenho/ciclos"
                        element={
                          <DesempenhoAccessGate>
                            <DesempenhoCiclos />
                          </DesempenhoAccessGate>
                      ...
                      />
                      <Route
                        path="/equipe/board/desempenho/metas"
                        element={
                          <DesempenhoAccessGate>
                            <DesempenhoMetas />
                          </DesempenhoAccessGate>
                      ...
                      />
                      <Route
                        path="/equipe/board/desempenho/feedbacks"
                        element={
                          <DesempenhoAccessGate>
                            <DesempenhoFeedbacks />
                          </DesempenhoAccessGate>
                      ...
                      />
                      <Route
                        path="/equipe/board/desempenho/1a1"
                        element={
                          <DesempenhoAccessGate>
                            <DesempenhoReunioes1a1 />
                          </DesempenhoAccessGate>
                        }
                      />
                      <Route
                        path="/equipe/board/desempenho/evolucao"
                        element={
                          <DesempenhoAccessGate>
                            <DesempenhoEvolucao />
                          </DesempenhoAccessGate>
                      ...
                      />
                      <Route
                        path="/equipe/board/desempenho/decisoes"
                        element={
                          <DesempenhoAccessGate>
                            <DesempenhoDecisoes />
                          </DesempenhoAccessGate>
                      ...
                      />
                      <Route
                        path="/equipe/board/desempenho/relatorios"
                        element={
                          <DesempenhoAccessGate>
                            <DesempenhoRelatorios />
                          </DesempenhoAccessGate>
                        }
                      />
                      <Route
                        path="/equipe/board/desempenho/minha-evolucao"
                        element={
                          <ProtectedRoute>
                            <MinhaEvolucao />
                          </ProtectedRoute>
