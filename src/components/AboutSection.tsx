...
export const AboutSection = () => {
  return (
    <section id="sobre" className="py-20 md:py-28 bg-gray-600">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          >
            ...
            <div className="pt-4 flex flex-wrap gap-x-8 gap-y-4">
              <div>
                <p className="text-2xl font-bold text-gray-50">Cuiabá</p>
                <p className="text-sm text-gray-400">Matriz - MT</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-gray-50">Barreiras</p>
                <p className="text-sm text-gray-400">Filial - BA</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-gray-50">Curitiba</p>
                <p className="text-sm text-gray-400">Filial - PR</p>
              </div>
            </div>
          </motion.div>
