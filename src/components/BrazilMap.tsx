...
const offices = [
  { id: "cuiaba", name: "Cuiabá", state: "MT", top: "42%", left: "38%", isMain: true },
  { id: "barreiras", name: "Barreiras", state: "BA", top: "35%", left: "62%", isMain: false },
  { id: "curitiba", name: "Curitiba", state: "PR", top: "70%", left: "55%", isMain: false },
];
