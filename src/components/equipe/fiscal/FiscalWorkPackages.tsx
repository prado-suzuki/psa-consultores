  ...
  const filters = useMemo(() => {
    ...
    switch (activeFilter) {
      case 'todos_abertos':
        ...
        break;
      case 'atrasados':
        // Filter will be applied client-side for due_date
        baseFilters.status = ['novo', 'pendente_agendamento', 'agendado', 'em_progresso', 'em_revisao'];
        break;
      case 'criado_por_mim':
      ...
      case 'ultima_atividade':
        // Will sort by updated_at client-side
        break;
    }
        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-48">
              <DropdownMenuItem onClick={() => setActiveFilter('todos_abertos')}>
                Todos abertos
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setActiveFilter('ultima_atividade')}>
                Ultima atividade
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setActiveFilter('atrasados')}>
                Atrasados
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => setActiveFilter('criado_por_mim')}>
                Criado por mim
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setActiveFilter('atribuido_a_mim')}>
                Atribuido a mim
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-slate-400">
            ...
            <p className="text-sm mt-1">
              Crie um novo pacote para comecar
            </p>
          </div>
        ) : (
          <Table>
