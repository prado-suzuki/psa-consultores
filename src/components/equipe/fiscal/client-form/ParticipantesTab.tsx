...
import { formatPhone, TIPO_PARTICIPANTE_OPTIONS } from "./constants";
...
interface ParticipantesTabProps {
  ...
  setDraftParticipant: React.Dispatch<React.SetStateAction<ParticipantesTabProps["draftParticipant"]>>;
