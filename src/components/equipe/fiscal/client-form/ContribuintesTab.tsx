...
import { formatCpfCnpj, formatCep, formatPhone, UF_STATES } from "./constants";
        ...
        {!isReadOnly && (
          <div className="bg-muted/50 rounded-lg border p-4">
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <div className="flex flex-row items-center gap-4">
                <Label className="w-48 shrink-0 text-xs font-semibold text-muted-foreground">
                  {draftEntity.tipo_pessoa === "PF" ? "CPF *" : "CNPJ *"}
                </Label>
                <div className="flex-1">
                  <div className="relative">
                    <Input
                      ...
                      placeholder={draftEntity.tipo_pessoa === "PF" ? "000.000.000-00" : "00.000.000/0000-00"}
                      className="font-mono pr-8 h-8"
                    />
                    {cnpjLoading && (
                      <Loader2 className="absolute right-2.5 top-2 h-4 w-4 animate-spin text-muted-foreground" />
              ...
              <div className="flex justify-end mt-2">
                <Button onClick={onAddEntity} className="gap-2">
                  Adicionar à Lista
                </Button>
              </div>
            </div>
