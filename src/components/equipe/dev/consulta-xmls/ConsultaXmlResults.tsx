...
function CteTable(props: Props) {
  return <Table className="min-w-[1050px]"><TableHeader><TableRow>
    ...
    <TableCell className="font-mono text-sm whitespace-nowrap">{formatCnpj(record.emit.CNPJ || "")}</TableCell><TableCell className="max-w-[200px]"><ElementTooltip text={record.emit.xNome}>
      <span className="truncate block">{record.emit.xNome}</span>
    </ElementTooltip></TableCell><TableCell className="hidden xl:table-cell"><ElementTooltip text={record.xMunIni}>
      <span className="truncate block">{record.xMunIni}</span>
    </ElementTooltip></TableCell><TableCell className="hidden xl:table-cell"><ElementTooltip text={record.xMunFim}>
      <span className="truncate block">{record.xMunFim}</span>
