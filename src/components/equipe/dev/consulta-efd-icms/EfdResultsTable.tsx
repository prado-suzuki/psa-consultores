...
function Empty({ icon, title, text }: { icon: React.ReactNode; title: string; text: string }) {
  return <div className="flex flex-col items-center justify-center text-center p-8 h-full min-h-[300px]"><div className="mb-4">{icon}</div><h3 className="text-xl font-bold text-slate-700">{title}</h3><p className="text-base text-slate-500 max-w-xs mt-2">{text}</p></div>;
}
