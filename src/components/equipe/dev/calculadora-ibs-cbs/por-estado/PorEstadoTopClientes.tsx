  ...
  return (
    <Card className="border-slate-200">
      ...
      <CardContent className="p-0">{clientes.length === 0 ? <p className="text-sm text-slate-400 py-12 text-center">Sem clientes para os filtros atuais</p> : <div className="overflow-x-auto"><Table>
        <TableHeader><TableRow className="bg-slate-50 hover:bg-slate-50"><TableHead className="w-12">#</TableHead><TableHead>Cliente</TableHead><TableHead>UF</TableHead><TableHead>Natureza</TableHead><TableHead>Produto principal</TableHead><TableHead className="text-right">NFs</TableHead><TableHead className="text-right">Faturamento</TableHead><TableHead className="text-right">% Total</TableHead></TableRow></TableHeader>
