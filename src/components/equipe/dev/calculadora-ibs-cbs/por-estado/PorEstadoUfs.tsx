    ...
    <div className="grid grid-cols-1 xl:grid-cols-5 gap-6">
      <Card className="border-slate-200 xl:col-span-2">
        ...
        <CardContent><div className="grid grid-cols-2 gap-3">{ufs.map((uf) => {
          ...
          return <button key={uf.uf} type="button" onClick={() => onSelecionarUf(uf.uf)} className="group relative rounded-lg border border-slate-200 overflow-hidden bg-white text-left hover:border-slate-400 hover:shadow-md transition-all cursor-pointer" title={`Ver detalhamento de ${uf.uf}`}>
      ...
      <Card className="border-slate-200 xl:col-span-3">
        ...
        <CardContent className="p-0"><div className="overflow-x-auto"><Table>
          <TableHeader><TableRow className="bg-slate-50 hover:bg-slate-50"><TableHead className="w-14">UF</TableHead><TableHead>Natureza</TableHead><TableHead className="text-right">Faturamento</TableHead><TableHead className="text-right">% Total</TableHead><TableHead className="text-right">NFs</TableHead><TableHead className="text-right">Ticket médio</TableHead><TableHead className="text-right">Carga antes</TableHead><TableHead className="text-right">Carga depois</TableHead><TableHead className="text-right">Δ pp</TableHead></TableRow></TableHeader>
