              ...
              <Table containerRef={scrollRef}>
                <TableHeader>
                  ...
                  <TableRow>
                    ...
                    <TableHead className="text-[11px] min-w-[80px]"><span className="flex items-center gap-1">{renderColumnLabel('Data', SPED_TOOLTIPS.d100Data)}<ColumnFilterDropdown columnKey="DT_DOC" uniqueValues={cascadingUniqueValues['DT_DOC'] ?? []} activeSort={sortConfig} activeFilter={columnFilters['DT_DOC'] ?? null} onSort={handleSort} onFilter={handleFilter} /></span></TableHead>
                    <TableHead className="text-[11px] min-w-[140px]"><span className="flex items-center gap-1">{renderColumnLabel('CHV CTe', SPED_TOOLTIPS.d100ChvCte)}<ColumnFilterDropdown columnKey="CHV_CTE" uniqueValues={cascadingUniqueValues['CHV_CTE'] ?? []} activeSort={sortConfig} activeFilter={columnFilters['CHV_CTE'] ?? null} onSort={handleSort} onFilter={handleFilter} /></span></TableHead>
