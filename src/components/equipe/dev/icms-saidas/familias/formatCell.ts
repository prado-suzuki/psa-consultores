const CURRENCY_RE = /(^|_)(VL|VALOR|ICMS|FUND|FUNDES|FUNDED|FUNDEIC|BC|CREDITO|TOTAL|PMPF)(_|$)/i;
const PERCENT_RE = /(ALIQ|PCT|PERCENT|BENEFICIO)/i;
const DATE_RE = /(DATA|DT_|DATA_NOTA)/i;
const ID_RE = /^(NF|NUM_NOTA|NUMERO_NOTA|ID_|MES_ANO|ANO_|MES_|CFOP|NCM|COD_|CST|CST_|CFOP_)/i;
