    ...
    <div className="min-h-screen bg-slate-50 flex w-full">
      ...
      >
        ...
        <div className="p-6 border-b border-slate-200/60">
          {collapsed ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-semibold text-slate-900 text-lg">Board</h2>
                <p className="text-xs text-slate-500">Área Board</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="p-4 border-t border-slate-200/60 space-y-2">
          ...
          <Button 
            variant="ghost" 
            className={`w-full ${collapsed ? 'justify-center px-2' : 'justify-start px-3'} py-2 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50 hover:text-indigo-600 transition-colors`}
