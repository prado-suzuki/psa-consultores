        ...
        <div className="modal-etapas edit-modal" style={{ position: 'relative' }}>
          ...
          <div className="etapas-layout">
            ...
            <div className="etapas-form-area">
              ...
              <div className="modal-section">
                <div className="modal-section-title"><Tooltip text={dica('mapear.secao.documentos')}>Documentos</Tooltip></div><div style={{ fontSize: '0.78rem', color: 'hsl(var(--slate-500))', marginBottom: 6 }}>O número ao lado de cada documento indica o <strong>volume por execução</strong>.</div>
              ...
              <div className="modal-section">
                ...
                <div style={{ fontSize: '0.78rem', color: 'hsl(var(--slate-500))', marginTop: 4 }}>Horas gasta por projeto: <strong>{formatDecimal(sumHorasEtapa(active, isFicou), 'h')}</strong></div>
              </div>
              <div className="modal-section">
