...
export function ExploracaoRuralImoveisTab({ tipo, imoveis, onChange, matriculas, instrumentosDeOrigem, avisoParaMatricula }: Props) {
  ...
  const add = () => {
    // `letraAlinea` (não charCode cru): o .docx oficial da Composse documenta origens
    // depois de "z" como "aa"/"bb" — o mesmo estilo de planilha que a função já cobre.
    const proximaLetra = letraAlinea(imoveis.length + 1);
            ...
            <div key={item.id} className="rounded-lg border border-osg-200/70 bg-background p-4">
              <div className="mb-3 flex items-center justify-between gap-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs font-bold text-osg-moss">Imóvel {letraAlinea(indice + 1)}</span>
              ...
              <div className={`${formGridCls(4)} gap-3`}>
                <Wide label="Imóvel / matrícula" trecho={{ tipo, campo: 'imovelMatricula' }}>
                ...
                <Field label="Área explorada" trecho={{ tipo, campo: 'imovelAreaExplorada' }}>
                  <Input value={item.areaExplorada} onChange={(e) => update(item.id, { areaExplorada: e.target.value })} className={`${fieldCls} font-mono`} />
                </Field>

                {isComposse && (
                  <>
                    <Field label="Tipo da origem" trecho={{ tipo: 'composse', campo: 'origemTipo' }}>
                    ...
                    <Wide label="Instrumento de origem" trecho={{ tipo: 'composse', campo: 'origemInstrumento' }}>
                      <Select
                    ...
                    {item.origemExterna && (
                      <div className={`${formSpanCls(4)} rounded-md border border-dashed border-osg-200 bg-osg-50/40 p-3`}>
                        ...
                        <div className={`${formGridCls(4)} gap-3`}>
                          <Wide label="Título do instrumento" trecho={{ tipo: 'composse', campo: 'origemTituloInstrumento' }}>
                          ...
                          <Field label="Data da origem" trecho={{ tipo: 'composse', campo: 'origemDataAssinatura' }}>
                          ...
                          <Field label="CPF/CNPJ da origem" trecho={{ tipo: 'composse', campo: 'origemOutorganteCnpj' }}>
                          ...
                          <Wide label="Outorgante da origem" trecho={{ tipo: 'composse', campo: 'origemOutorganteNome' }}>
                          ...
                          <Field label="Sede — município" trecho={{ tipo: 'composse', campo: 'origemOutorganteSede' }}>
                          ...
                          <Field label="Sede — UF" trecho={{ tipo: 'composse', campo: 'origemOutorganteSede' }}>
                          ...
                          <Field label="NIRE" trecho={{ tipo: 'composse', campo: 'origemOutorganteNire' }}>
                          ...
                          <Field label="Capital social na assinatura" trecho={{ tipo: 'composse', campo: 'origemOutorganteCapitalSocial' }}>
                          ...
                          <Wide label="Administradores da origem" trecho={{ tipo: 'composse', campo: 'origemOutorganteAdministradores' }}>
