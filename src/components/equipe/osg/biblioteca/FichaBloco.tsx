  ...
  const carta = (
    <div
      ...
      className={cn(
        ...
        'group relative flex cursor-pointer flex-col gap-1.5 rounded-md border border-osg-300/60 bg-field p-3.5 pl-4 shadow-sm shadow-osg-300/30 animate-osg-card-in',
