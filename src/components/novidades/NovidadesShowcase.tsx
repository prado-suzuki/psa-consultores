...
export const NovidadesShowcase = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <Link
        to="/novidades"
        className="mt-6 flex items-center justify-center gap-2 rounded-lg bg-white text-primary font-semibold text-base py-3 transition-colors hover:bg-accent/5"
      >
