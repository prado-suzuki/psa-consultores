...
export const TOOLTIPS: Record<string, string> = {
  ...
  'projetos.form.dataInicio': 'Data de início do projeto (opcional).',
  'projetos.form.dataFim': 'Data prevista de término (opcional).',
  ...
  'processos.form.frequencia': 'Quantas vezes o processo roda por ano — anualiza os custos no ROI.',
  'processos.form.entregavel': 'Resultado final entregue ao concluir o processo.',
  'processos.form.statusAvaliacao': 'Situação da avaliação: Não avaliado, Em avaliação ou Avaliado.',
  'processos.form.complexidade': 'Grau de complexidade do processo (Baixa, Média, Alta).',
  ...
  'responsaveis.form.custoHora': 'Custo por hora trabalhada — base para valorar todas as horas.',
  ...
  'responsaveis.col.custoHora': 'Custo por hora usado nos cálculos de custo.',
  ...
  'sistemas.form.responsaveisHoras': 'Horas internas de implantação — entram no investimento.',
  ...
  'melhorias.form.custoExternoUnico': 'Custo externo único (consultoria/fornecedor) — entra no investimento.',
  ...
  'mapear.etapa.execucao': 'Como a etapa é executada: manual, semi-automática ou automática.',
  ...
  'mapear.etapa.volumePorProcesso': 'Quantas vezes a etapa se repete dentro de uma execução do processo (ex.: 3 = a etapa roda 3x por execução). Multiplica horas e custos da etapa.',
  'mapear.etapa.taxaErros': 'Percentual (0–100) das execuções desta etapa que produzem erro. Mede ocorrência de falha — é indicador de qualidade, não entra direto no custo.',
  'mapear.etapa.taxaRetrabalho': 'Percentual (0–100) das horas da etapa que se repetem por retrabalho. Mede esforço perdido — entra no custo: horas × taxa = horas refeitas. Uma etapa pode ter 30% de erros e só 5% de retrabalho se cada erro for trivial de corrigir.',
  ...
  'dashboard.kpi.economiaAnual': 'Quanto deixa de ser gasto por ano após as melhorias.',
  'dashboard.kpi.roi': 'Retorno percentual sobre o investimento, em 12 meses.',
  'dashboard.kpi.payback': 'Meses para a economia recuperar o investimento.',
  'dashboard.kpi.horasLiberadas': 'Horas/ano da equipe liberadas para outras atividades.',
  ...
  'dashboard.kpi.investimento': 'Total a investir (pagamento único) para alcançar o cenário projetado.',
  ...
  'setor.kpi.horasLiberadas': 'Soma das horas liberadas entre baseline e última medição.',
