 ...
 * `vocabularioDa*`, `redacaoDoCapital` e `redacaoDaGovernanca`, em mapeadores.ts). Não são cadastro nem
 * texto livre: pedi-las à mão mostraria a chave crua e o valor digitado seria
 * sobrescrito.
 */
export const VOCABULARIOS_DA_GERACAO = ['retirada', 'requalificacao', 'redacaoCapital', 'redacaoGovernanca', 'preferencia'] as const;
