...
export const statusColors: Record<OrgTaskStatus, StatusColorConfig> = {
  ...
  in_progress:    { key: 'in_progress', papel: 'andamento',    label: 'Em Andamento',      bg: 'bg-status-andamento-soft',  text: 'text-status-andamento',  bgSolid: 'bg-status-andamento',  combined: 'bg-status-andamento-soft text-status-andamento' },
