...
const FILA_DO_ALERTA: Record<MotivoDeFicar, Record<string, number>> = {
  'escada-de-status': {
    ...
    'src/components/equipe/mapeamento/MetricsCards.tsx': 2,
    'src/components/equipe/mapeamento/ProcessSpreadsheet.tsx': 3,
    ...
    'src/components/equipe/sprint-detalhes/DeliverableFormFields.tsx': 1,
