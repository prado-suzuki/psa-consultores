...
export default function ResetPassword() {
  ...
  if (!isRecovery) {
    return (
      <div className="min-h-screen flex items-center justify-center dark bg-background text-foreground p-8">
        <div className="w-full max-w-md text-center space-y-6">
          <img src={logo} alt="PSA Consultores" className="h-16 mx-auto" />
          <div className="space-y-2">
            <h2 className="text-2xl font-bold">Redefinição de Senha</h2>
    ...
    <div className="min-h-screen flex items-center justify-center dark bg-background text-foreground p-8">
      <div className="w-full max-w-md space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="new-password" className="text-muted-foreground">Nova Senha <RequiredMark /></Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="confirm-password" className="text-muted-foreground">Confirmar Senha <RequiredMark /></Label>
            <Input
              id="confirm-password"
              type={showPassword ? 'text' : 'password'}
              placeholder="••••••••"
