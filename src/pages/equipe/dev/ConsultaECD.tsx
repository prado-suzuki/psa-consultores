...
const ConsultaECD = () => {
  ...
  } = useDomainConsultaECD(selectedCliente);
  ...
  const handleDownloadAll = async () => {
    ...
    try {
      const url = new URL(getApiUrl(`/api/v1/query/download/efd/ecd/${selectedContribuinte}`));
  ...
  return (
    ...
    >
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <span className="text-sm font-bold text-foreground">Escrituração Contábil Digital</span>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-muted border-b border-border">
                    ...
                    <th className="px-6 py-4 text-xs font-bold text-muted-foreground uppercase tracking-wider"><ColumnTooltip label="Finalidade"text={TOOLTIPS.colFinalidade} /></th>
                    ...
                    <tr key={arquivo.ID_ARQUIVO} className="hover:bg-muted transition-colors group">
                      ...
                      <td className="px-6 py-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <EFDExportDialog arquivo={arquivo} blocosDisponiveis={blocosDisponiveis} tipo="ecd" idContribuinte={selectedContribuinte} />
      ...
      <EFDAnalysisModal open={analysisModalOpen} onOpenChange={setAnalysisModalOpen} arquivo={selectedArquivo} blocosDisponiveis={blocosDisponiveis} idContribuinte={selectedContribuinte} tipo="ecd" />
      {arquivoParaExportar && (
        <EFDExportDialog arquivo={arquivoParaExportar} blocosDisponiveis={blocosDisponiveis} tipo="ecd" profileType="efd_ecd" idContribuinte={selectedContribuinte} externalOpen={exportDialogOpen} onExternalOpenChange={setExportDialogOpen} hideTrigger />
      )}
      </TooltipProvider>
    </DevLayout>
  );
