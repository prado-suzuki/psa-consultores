            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`text-gray-900 placeholder:text-gray-400 ${errors.email ? 'border-destructive' : ''}`}
                />
                {errors.email && (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`text-gray-900 placeholder:text-gray-400 ${errors.password ? 'border-destructive' : ''}`}
                  />
                  <button
                    type="button"
            ...
            <form onSubmit={handleRegister} className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={`text-gray-900 placeholder:text-gray-400 ${errors.firstName ? 'border-destructive' : ''}`}
                  />
                  {errors.firstName && (
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={`text-gray-900 placeholder:text-gray-400 ${errors.lastName ? 'border-destructive' : ''}`}
                  />
                  {errors.lastName && (
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`text-gray-900 placeholder:text-gray-400 ${errors.confirmPassword ? 'border-destructive' : ''}`}
                />
