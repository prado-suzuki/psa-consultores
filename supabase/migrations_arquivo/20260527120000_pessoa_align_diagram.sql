-- =========================================================
-- Alinha a tabela pessoa ao diagrama ER
-- - Renomeia RG -> documento_identidade_* (+ tipo)
-- - Adiciona campos PF que faltavam no banco
-- - Mantém denominacao e conjuge_id (decisão de projeto)
-- =========================================================

-- 1) Renomeia os campos de RG para documento de identidade genérico
