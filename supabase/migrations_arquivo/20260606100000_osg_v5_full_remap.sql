...
VALUES
  (mapa_uuid('prj-osg-p1'), 'P1 - Organização Patrimonial',
   ...
   '0523512c-f980-4236-8a7c-53e06c9c7a80', 'Mapeamento', 'OSG', NOW(), NOW()),
...
VALUES
  ...
  (mapa_uuid('doc-osg-car'),                            'CAR (Cadastro Ambiental Rural)',                 'PDF',  'Cliente',   '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  ...
  (mapa_uuid('doc-osg-doc-georreferenciamento'),        'Documento de georreferenciamento (SIGEF)',       'PDF',  'Cliente',   '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  ...
  (mapa_uuid('doc-osg-nota-devolutiva'),                'Nota devolutiva do cartório',                    'PDF',  'Interno',        '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-matricula-atualizada'),           'Matrícula atualizada (pós-integralização)',      'PDF',  'Interno',        '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),

  -- Papéis de trabalho PSA
  (mapa_uuid('doc-osg-dp'),                             'Diagnóstico Patrimonial (DP)',                   'Excel','Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-wp-matricula'),                   'WP Digitação de Matrícula',                      'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-wp-socios'),                      'WP Qualificação dos Sócios',                     'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-planilha-capital-social'),        'Planilha de Capital Social',                     'Excel','Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-checklist-impedimentos'),         'Checklist de impedimentos de matrícula',         'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-checklist-revisao'),              'Checklist de revisão de minuta',                 'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-memorando-docs'),                 'Memorando de documentos preliminares',           'PDF',  'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-ata-kickoff'),                    'Ata de Kickoff',                                 'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-ppt-apresentacao-projeto'),       'Apresentação do Projeto (PPT)',                  'PowerPoint','Interno',        '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-ppt-apresentacao-sucessao'),      'Apresentação Final de Sucessão (3 cenários ITCMD)','PowerPoint','Interno',       '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-contrato-psa-cliente'),           'Contrato PSA × Cliente (formalização)',          'PDF',  'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-relatorio-final'),                'Relatório final do projeto',                     'PDF',  'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-planilha-itcmd'),                 'Planilha cálculo ITCMD (3 cenários)',            'Excel','Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-planilha-plan-trib-rural'),       'Planilha Planejamento Tributário Rural',         'Excel','Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-planilha-protocolo-remuneracao'), 'Planilha Protocolo de Remuneração',              'Excel','Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-questionario-gov'),               'Questionário de Governança (PSA)',               'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),

  -- Minutas e documentos finalizados — abrangem entrada (minuta), saída assinada (cliente) e registrada (Junta/Cartório)
  (mapa_uuid('doc-osg-minuta-cs-agro'),                 'Minuta Contrato Social Agro',                    'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-cs-agro-registrado'),             'Contrato Social Agro registrado',                'PDF',  'Interno', '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-cs-participacoes'),        'Minuta Contrato Social Participações',           'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-cs-participacoes-registrado'),    'Contrato Social Participações registrado',       'PDF',  'Interno', '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-cs-holding'),              'Minuta Contrato Social Holding Individual',      'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-cs-holding-registrado'),          'Contrato Social Holding Individual registrado',  'PDF',  'Interno', '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-ac-agro-integ'),           'Minuta AC Agro - Integralização (cl. 5ª)',       'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-ac-agro-integ-registrada'),       'AC Agro - Integralização registrada',            'PDF',  'Interno', '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-ac-participacoes-cessao'), 'Minuta AC Participações - Cessão de Cotas',      'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-ac-participacoes-cessao-reg'),    'AC Participações - Cessão registrada',           'PDF',  'Interno', '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-ac-imovel-adicional'),     'Minuta AC Agro - Imóvel Adicional (2º momento)', 'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-ac-imovel-adicional-reg'),        'AC Agro - Imóvel Adicional registrada',          'PDF',  'Interno', '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-protocolo-justificacao-reorg'),   'Protocolo e Justificação (Reorganização)',       'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-laudo-avaliacao-reorg'),          'Laudo de avaliação (Reorganização)',             'PDF',  'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-ata-reuniao-socios'),             'Ata de Reunião de Sócios',                       'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-ac-exigencia-cartorial'),  'Minuta AC por Exigência Cartorial',              'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-distrato'),                'Minuta de Distrato de Arrendamento',             'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-distrato-registrado'),            'Distrato registrado em cartório',                'PDF',  'Interno',        '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-parceria'),                'Minuta Contrato de Parceria Rural + Anexo',      'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-parceria-registrada'),            'Contrato de Parceria registrado em cartório',    'PDF',  'Interno',        '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-composse'),                'Minuta Contrato de Composse + Anexo',            'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-composse-registrada'),            'Contrato de Composse registrado',                'PDF',  'Interno',        '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-termo-encerramento-safra'),       'Termo de Encerramento de Safra',                 'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-doacao'),                  'Minuta Instrumento de Doação de Cotas',          'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-doacao-assinada'),                'Instrumento de Doação assinado',                 'PDF',  'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-ac-doacao-reflexo'),       'Minuta AC Participações - Reflexo da Doação',    'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-ac-doacao-registrada'),           'AC Participações - Doação registrada',           'PDF',  'Interno', '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-testamento'),              'Minuta de Testamento',                           'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-testamento-lavrado'),             'Testamento lavrado em cartório de notas',        'PDF',  'Interno',        '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-acordo-quotistas'),        'Minuta Acordo de Quotistas',                     'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-acordo-quotistas-assinado'),      'Acordo de Quotistas assinado',                   'PDF',  'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-protocolo-remuneracao-final'),    'Protocolo de Remuneração (final)',               'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-matriz-alcadas'),                 'Matriz de Alçadas',                              'Excel','Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-regimento-conselho'),             'Regimento Interno do Conselho',                  'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-minuta-ac-gov-reflexo'),          'Minuta AC Participações - Reflexo Governança',   'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-ac-gov-registrada'),              'AC Participações - Governança registrada',       'PDF',  'Interno', '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-diagnostico-flash'),              'Diagnóstico Flash (encerramento)',               'Word', 'Interno',             '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW()),
  (mapa_uuid('doc-osg-dac-diretores'),                  'DAC - Descrição e Análise de Cargo dos Diretores','Word','Interno',              '0523512c-f980-4236-8a7c-53e06c9c7a80', NOW(), NOW());
