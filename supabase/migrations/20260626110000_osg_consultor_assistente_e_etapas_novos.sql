-- ============================================================================
-- OSG — Cargo Consultor Assistente + etapas dos 5 processos novos (3ª reunião).
-- Migração única: (1) cria o cargo Consultor Assistente (cargo oficial da OSG;
-- valores INFERIDOS: Consultoria/junior, R$35/h, monthly_salary_ref 3500 — ajustáveis);
-- (2) re-aponta as etapas OSG hoje em 'Assistente Administrativo' (placeholder) para ele;
-- (3) insere as etapas+responsáveis ESTIMADAS dos 5 processos novos (sem mapeamento prévio).
-- scenario AS-IS, volume_per_process=1, horas por UMA execução. Referencia processos por
-- CODE e cargos por NAME (à prova de rebuild). Escopo: SOMENTE cluster OSG.
-- ============================================================================
BEGIN;
...
-- (1) cria o cargo Consultor Assistente
...
-- (2) re-aponta etapas OSG de Assistente Administrativo -> Consultor Assistente
...
-- (3) etapas + responsáveis estimados dos 5 processos novos
-- PROC-GERAL-037 · Relatório de documentos pendentes
...
-- PROC-GERAL-038 · Documentos complementares
INSERT INTO public.process_stages (id, process_id, stage_order, name, scenario, execution, volume_per_process)
...
-- PROC-GERAL-039 · Regularização da situação Matrimonial
INSERT INTO public.process_stages (id, process_id, stage_order, name, scenario, execution, volume_per_process)
...
-- PROC-GERAL-040 · Estruturação de Cisão, incorporação e fusão
INSERT INTO public.process_stages (id, process_id, stage_order, name, scenario, execution, volume_per_process)
...
-- PROC-GERAL-041 · Revisão da Parceria e da Composse
INSERT INTO public.process_stages (id, process_id, stage_order, name, scenario, execution, volume_per_process)
