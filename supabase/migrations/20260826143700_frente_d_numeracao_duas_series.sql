...
--
-- A alteração e o contrato consolidado são dois instrumentos encadeados na
-- mesma peça. As resoluções consomem a primeira série de cláusulas; o cabeçalho
-- da consolidação abre outra, para que o contrato volte à Cláusula Primeira.
--
-- As rubricas das resoluções existiam apenas para simular títulos enquanto os
-- blocos eram livres. Ao torná-los cláusulas, o motor escreve o título e a
-- redação sem rubrica precisa ser uma nova versão para preservar documentos já
-- validados.
--
...
-- Os IDs das resoluções são estáveis desde a migration 20260825194340. Os
-- blocos de moldura vêm da Frente B e são encontrados pelo nome de catálogo,
-- sem repetir aqui os IDs escolhidos por aquela migration.
