...
--
-- O id de cada cliente está escrito aqui, não é gerado pelo banco. É de
-- propósito: o trigger normalize_name_title_case roda initcap() no nome durante
-- o INSERT ("Araguaia S.A." vira "Araguaia S.a."), então casar pelo nome depois
-- de gravar não é confiável. Com o id fixo, a etapa 2 já sabe a que cliente
-- pendurar cada contribuinte sem depender do retorno desta migration.
--
-- REVERSÃO (nesta ordem, senão o trigger do último cluster barra):
--   BEGIN;
--   UPDATE public.cliente SET excluido = true WHERE id IN (<a lista de ids abaixo>);
--   DELETE FROM public.cliente_clusters WHERE cliente_id IN (<a mesma lista>);
--   DELETE FROM public.cliente WHERE id IN (<a mesma lista>);
--   COMMIT;
...
-- ── Resultado. Os ids já são conhecidos (estão acima), então a etapa 2 não
--    depende deste retorno. Ele serve de conferência. ────────────────────────
...
WHERE c.id IN (
    '92d48042-2e01-5dfb-8d46-f74e9fb31af9',
    '1cb5748d-65f9-5abf-bc6f-47782c063c49',
    '280ee933-f6bc-5572-86d3-2dcc4a118349',
    'af33c72b-199a-5079-a876-202e04e29f9e',
    '7e957b82-0956-5145-9f9b-f1ab309351d3',
    '03fb01bd-0aab-5ad7-8cc8-10dbe7cc6251',
    '03ee96ae-0233-5c80-bc97-89249d77f0bc',
    '10b16f5e-cb5b-5c4a-977c-695c7e073b7e',
    '7c635f5b-d23b-5f2a-a56e-d55e5d574008',
    '267b7f00-0f90-5e34-9012-46e6e5f17485',
    '12cda94e-a9b5-5b67-9eb0-ff8d60b78c6b',
    '1c41e99d-551c-59fc-8b29-ed7b3d72076b',
    '5ecab204-beb6-59cc-a53e-2894fdb10f13',
    '6a80da84-d17c-55ef-b45d-a92e239a2cd9',
    '762c9044-9140-5eba-9b3c-8fcd5f36e589',
    '01296272-f0cf-5cce-96bd-b31cab7897fc',
    'cc49d1e0-2822-5fc8-bd15-f440971d85f1',
    '497c1ae8-203f-5ae1-934f-d074e8899142',
    '8f6d5026-08ce-5506-b9bc-eec68946ceff',
    '3564bdda-3459-5ebd-8d23-81b8fe014b64',
    '86515e2b-499c-567d-9edb-ca622eb02796',
    'd70b13ad-1e30-5379-8e31-f75da7f729d6',
    '5eb1d556-1a95-5642-9fca-9ef894e63b3e',
    '27aa4540-6500-5bc3-9c5c-63be8232fd6b',
    '11a42af1-df45-5c69-9b61-013e0870e96e',
    'f7dda35d-7acf-5f5f-b324-240398b97b82',
    '678a3639-832a-5dc5-a3d0-7ee60c04f4e5',
    '0c5a0cc5-8e03-5566-b354-56119c3865ef',
    '0be1b087-1268-5ffc-817a-f17bc2e67add',
    '01fe755a-1249-5b7e-9e08-fe4504dd6de8',
    'bf9d2fad-b79e-55fc-9513-6bb67aecfc1d',
    'ed6d2389-b2dc-511b-9831-eada3c94e643',
    '219e9a33-767d-55de-8b39-bab3c7aeb3ac',
    '62144ede-6dd9-5939-b146-9acf30d74cca',
    '4afca016-c3ad-5721-8fb4-086be6fa6e1d',
    '2ca2d795-fec7-5120-bccd-9e13fe26e12b',
    '48465ca1-45e6-5137-a30b-d038041bad70',
    'a60100a2-619c-568e-9391-4f9fe3d22b90',
    '48e33786-5518-59a3-ae20-9d38baca001b',
    'cf257ce4-78fa-58ce-9bf5-78e69ffc176b'
  )
