-- lovable-cron-fallback-reviewed: 96 runs/day; avisos de tarefa nascem de trigger ao longo do dia e precisam chegar ao espaco do Chat em minutos; job nasce desativado
