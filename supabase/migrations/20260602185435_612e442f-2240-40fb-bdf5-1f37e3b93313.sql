...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.administracao TO authenticated;
GRANT ALL ON public.administracao TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.quadro_societario TO authenticated;
GRANT ALL ON public.quadro_societario TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.capital_integralizacao TO authenticated;
GRANT ALL ON public.capital_integralizacao TO service_role;
