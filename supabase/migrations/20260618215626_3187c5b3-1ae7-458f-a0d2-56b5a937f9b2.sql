...
create table if not exists public.documento_arquivo (
  ...
  org_projects_id     uuid,
  documento_gerado_id uuid references public.documento_gerado(id) on delete set null,
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.documento_arquivo TO authenticated;
GRANT ALL ON public.documento_arquivo TO service_role;
