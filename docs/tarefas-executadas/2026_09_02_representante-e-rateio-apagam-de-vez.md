...
> está em [tarefa separada](2026_09_02_ordem-de-servico-apaga-de-vez.md); `cliente_clusters`,
...
**Fase 2: limpa e simplifica.** Apaga as 198 linhas já marcadas e derruba a coluna. Depois
...
4. `soft_delete_distribuicao_receita` fica sem chamador. **Não derrubar ainda**: a
   [tarefa da OS](2026_09_02_ordem-de-servico-apaga-de-vez.md) confirma que ninguém mais usa antes de remover.
...
Antes de rodar, refazer a contagem: hoje são **9** e **189**. Se vier bem diferente, parar e
entender por quê.
...
Na fase 1 os números ficam parados em 9 e 189 (nada novo é marcado). Na fase 2, zeram.
