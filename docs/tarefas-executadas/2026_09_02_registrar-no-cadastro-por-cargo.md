...
> de cliente. As outras: [alterar](2026_09_02_alterar-no-cadastro-por-cargo.md) ·
> [excluir](2026_09_02_excluir-cliente-e-contribuinte-por-cargo.md) · [mensagens](2026_09_02_mensagens-de-recusa-do-cadastro.md).
>
...
- **O desfazer.** Se algum passo falhar por outro motivo, a tela ainda não consegue apagar o
  ...
  [tarefa de excluir](2026_09_02_excluir-cliente-e-contribuinte-por-cargo.md). Até lá, uma falha no meio continua
...
- **A mensagem** continua dizendo "Sem permissão para cadastrar cliente" com o texto cru do
  banco — [tarefa das mensagens](2026_09_02_mensagens-de-recusa-do-cadastro.md).
