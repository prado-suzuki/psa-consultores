...
> [ordem de serviço](2026_09_02_ordem-de-servico-apaga-de-vez.md).
>
...
produtos. Hoje esse apagar exige `cliente_visivel_para` e atinge **zero linhas, sem devolver
erro**. A tela já não acredita que desfez: desde `1b7b8da9` (02/09) o rollback relê a linha e,
se ela continuar lá, solta um segundo toast dizendo que a exclusão falhou. O que falta é o
desfazer pegar.
...
> **03/09:** saíram dois vizinhos deste defeito, e nenhum deles é ele. O clique dobrado, que
> rodava dois cadastros do mesmo cliente, e a rejeição que desaparecia sem aviso (`3a582bdb` e
> `b1fcbb85`). O hook ganhou os primeiros arquivos de teste, 10 deles, onde a conferência de T2
> cabe como teste em vez de roteiro manual.
