...
>
> **É a conversão com mais travas, e todas foram decididas em 02/09.** As outras duas estão em
> [representante e rateio](2026_09_02_representante-e-rateio-apagam-de-vez.md).
...
| `solicitacao` | `ordem_servico_id` | **SET NULL**, sobrevive e perde o vínculo | **sim, passa a bloquear** → T1b |
...
apagar a OS"*. Vale para **qualquer** solicitação, aberta ou encerrada.
...
errado**: uma OS que nasceu por engano e não tem nada pendurado nela. Nas palavras da Patricia
...
diferença é que agora sai de graça, pela chave estrangeira, em vez de por trigger. **É o que
aposenta a tarefa da cascata**, que existia só para fazer à mão o que a exclusão física faz
sozinha.
...
estrangeira. Hoje ela está como `SET NULL`, e a solicitação sobrevivia e ficava sem vínculo.
...
> aberto, e situação é coisa que chave estrangeira não sabe ler, o que exigiria um gatilho
...
[tarefa do representante e rateio](2026_09_02_representante-e-rateio-apagam-de-vez.md) a deixa sem
chamador mas não a remove, e as duas precisam ter saído do front antes.
