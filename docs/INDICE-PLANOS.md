...
| [`planos/projetos-tarefas-no-celular.md`](planos/projetos-tarefas-no-celular.md) | 🟡 PARCIAL | **Fases 1 a 6 feitas, 7 e 8 abertas.** Uma tela só (`PainelTarefas`) servindo 4 rotas de Tax e OSG. Roda uma fase por commit, com validação visual da Patrícia entre uma e outra. A ressalva do arrastar no Kanban está **decidida**: no celular a tela é só leitura, então não abrir frente de biblioteca de DnD |
