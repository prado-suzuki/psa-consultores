...
|---|---|---|
| [`planos/valor-contabil-por-titular-e-integralizacao-parcial.md`](planos/valor-contabil-por-titular-e-integralizacao-parcial.md) | 🟡 PARCIAL | Plano de 14/09/2026, a partir do que a OSG relatou: valor contábil e valor a integralizar **por titular** da matrícula, integralização parcial (titular sem valor fica de fora do capital e das quotas) e aviso quando o valor a integralizar foge da fração. **Executado em 14/09/2026 na `develop`**, passos 2 a 6 do §10: migration com backfill que reproduz o rateio de hoje, cadastro e aviso na tela, e os cinco pontos do mapeador lendo o valor em vez da fração. O §0 do plano registra o que foi entregue e a divergência de desenho (a leitura por valor é ligada por MATRÍCULA, não por titular). Falta: o §4 com a OSG (qual valor a cláusula imprime) e a revisão dos blocos da biblioteca que depende dele; a tela do aumento de capital; e **produção ainda não recebeu as duas colunas** |
