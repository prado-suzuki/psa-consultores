...
| [`osg/doacao-de-quotas-com-usufruto.md`](osg/doacao-de-quotas-com-usufruto.md) | 🟡 PARCIAL | Doação de quotas com reserva de usufruto, em quatro fatias. **Fatia 1 entregue em 10/09/2026** (migration `20260910202720` aplicada no sandbox; produção pendente): o evento entra no livro pelo Quadro Societário, com o ônus em `onus_quotas` como estado da sociedade, e a tabela de usufruto e voto na página. **Abertas**: a peça (fatia 2, precisa do aceite da redação jurídica), os três ecos do gravame na consolidação (3) e as variantes de cessão gratuita e instituição avulsa (4) |
