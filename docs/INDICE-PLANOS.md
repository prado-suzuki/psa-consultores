...
| [`planos/projetos-tarefas-no-celular.md`](planos/projetos-tarefas-no-celular.md) | 🔵 ABERTO | **7 fases, nenhuma feita.** Uma tela só (`PainelTarefas`) servindo 4 rotas de Tax e OSG. Roda uma fase por commit, com validação visual da Patrícia entre uma e outra. A ressalva da fase 5 vale antes de começar: arrastar cartão no Kanban usa DnD do HTML5, que **não dispara em toque** |
