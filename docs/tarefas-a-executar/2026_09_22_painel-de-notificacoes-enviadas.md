...
>
> **Irmã da [TAREFA 1](2026_09_23_lista-geral-de-solicitacoes.md).** Mesmo formato de problema
...
5. **Os valores reais do enum `notificacao_envio_status`.** O `awk` no baseline não os
   ...
   em produção** (`docs/geral/ale-1-registro-notificacao-tipo-chamado.md`), fora do fluxo de
...
- **Propagar o erro em vez de devolver lista vazia.** O hook existente já faz isso
  ...
  [TAREFA 4](2026_09_23_consistencia-das-telas-de-estrutura-do-cliente.md) aplica nas cinco
...
| `docs/geral/ale-1-registro-notificacao-tipo-chamado.md` | a origem do log por destinatário, e o registro de que 5 valores foram aplicados à mão em produção |
