...
[TAREFA 6](2026_09_22_crons-de-notificacao-em-producao.md).

### T6 — Provar com as tarefas desta sprint

O teste de aceitação não é sintético: criar como itens de backlog as
[TAREFA 5](2026_09_22_painel-de-notificacoes-enviadas.md),
[6](2026_09_22_crons-de-notificacao-em-producao.md) e
[7](2026_09_22_prefixo-teste-nos-cadastros-de-dev.md), cada uma com o caminho do `.md` no
