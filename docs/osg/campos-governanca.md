...
> **Correção de 19/08/2026, posterior a este levantamento.** A palavra "referencia" acima
> ficou forte demais. Medido nas duas matrizes reais (EVMT e Bigolin) e no modelo xlsx:
> **zero menção** a protocolo, regimento ou acordo. O que existe é **coincidência de
> assunto**, não citação. O eixo de REGISTRO é o contrato social; a Matriz é o eixo da
> DECISÃO. Mantida a frase original para preservar o que foi escrito em 14/08.
