...
**189 tabelas** de negocio · 2 de backup (ignorar) · 42 enums.
...
| [`acordo_ordem_preferencia`](#acordoordempreferencia) | 8 | — | interno | acordo_quotistas |
| [`acordo_quorum`](#acordoquorum) | 12 | — | interno | acordo_quotistas |
| [`acordo_quotistas`](#acordoquotistas) | 35 | excluido | interno | cliente, pessoa |
| [`acordo_ramo_familiar`](#acordoramofamiliar) | 8 | — | interno | acordo_quotistas |
| [`acordo_signatario`](#acordosignatario) | 8 | — | interno | acordo_quotistas, pessoa |
| [`acordo_sociedade_relacionada`](#acordosociedaderelacionada) | 8 | — | interno | acordo_quotistas, pessoa |
...
| [`atividade_governanca`](#atividadegovernanca) | 9 | excluido | interno | cliente |
...
| [`checklist_cliente_item`](#checklistclienteitem) | 21 | — | cluster-cliente | bem, cliente, documento_tipo, matricula, pessoa |
...
| [`daily_standups`](#dailystandups) | 12 | — | sprint | sprint_deliverables, processes, projects, sprint_resumo, sprints |
...
| [`distribuicao_receita`](#distribuicaoreceita) | 5 | — | cluster-cliente | centros_custo, ordem_servico |
...
| [`documento_gerado`](#documentogerado) | 22 | — | interno | documento_gerado, cliente, profiles, tmpl_documento, pessoa |
...
| [`documento_tipo`](#documentotipo) | 23 | — | interno | cliente, solicitacao_item |
...
| [`estrutura_areas`](#estruturaareas) | 11 | — | catalogo | estrutura_clusters, centros_custo, profiles |
...
| [`exploracao_rural`](#exploracaorural) | 32 | — | cluster-cliente | cliente, documento_arquivo, pessoa |
| [`exploracao_rural_imovel`](#exploracaoruralimovel) | 14 | — | interno | exploracao_rural, matricula, pessoa, exploracao_rural_origem_externa |
| [`exploracao_rural_origem_externa`](#exploracaoruralorigemexterna) | 11 | — | interno | exploracao_rural, pessoa |
| [`exploracao_rural_parte`](#exploracaoruralparte) | 10 | — | interno | exploracao_rural, pessoa |
...
| [`matricula`](#matricula) | 33 | — | cluster-cliente | bem, cartorio, cliente, profiles, matricula |
| [`matriz_alcadas`](#matrizalcadas) | 9 | excluido | interno | cliente |
| [`matriz_atividade`](#matrizatividade) | 9 | — | interno | atividade_governanca, matriz_alcadas |
| [`matriz_competencia`](#matrizcompetencia) | 13 | — | interno | matriz_atividade, orgao_governanca |
| [`matriz_competencia_papel`](#matrizcompetenciapapel) | 5 | — | interno | matriz_competencia, papel_governanca |
...
| [`movimentacao_quotas`](#movimentacaoquotas) | 29 | — | interno | bem, cliente, profiles, ato_societario, pessoa, documento_gerado |
...
| [`ordem_servico`](#ordemservico) | 22 | — | cluster-cliente | estrutura_clusters, contribuinte, produto_segmento, servicos_prestados, setor_cliente |
...
| [`org_feed_visto`](#orgfeedvisto) | 3 | — | interno | profiles |
...
| [`papel_governanca`](#papelgovernanca) | 11 | excluido | interno | cliente |
...
| [`pessoa`](#pessoa) | 42 | — | cluster-cliente | cliente, pessoa, contribuinte, profiles |
...
| [`produto_documento_tipo`](#produtodocumentotipo) | 8 | — | interno | documento_tipo, produto_segmento |
| [`produto_segmento`](#produtosegmento) | 7 | — | catalogo | estrutura_clusters |
| [`produto_servico`](#produtoservico) | 3 | — | catalogo | produto_segmento, servicos_prestados |
| [`produto_tarefa_padrao`](#produtotarefapadrao) | 13 | — | interno | produto_segmento |
| [`profiles`](#profiles) | 11 | — | proprio-usuario | — |
| [`project_documents`](#projectdocuments) | 13 | — | interno | processes, sprint_resumo, sprints, profiles |
...
| [`protocolo_beneficiario`](#protocolobeneficiario) | 9 | excluido | interno | protocolo_remuneracao |
| [`protocolo_item_governanca`](#protocoloitemgovernanca) | 10 | excluido | interno | cliente, protocolo_tema_governanca |
| [`protocolo_linha`](#protocololinha) | 8 | — | interno | protocolo_item_governanca, protocolo_remuneracao |
| [`protocolo_regra`](#protocoloregra) | 8 | — | interno | protocolo_beneficiario, protocolo_linha |
| [`protocolo_remuneracao`](#protocoloremuneracao) | 9 | excluido | interno | cliente |
| [`protocolo_tema_governanca`](#protocolotemagovernanca) | 9 | excluido | interno | cliente |
| [`psa_migrations_aplicadas`](#psamigrationsaplicadas) | 6 | — | interno | — |
| [`relatorios_gerados`](#relatoriosgerados) | 8 | — | interno | ciclos_avaliacao |
| [`representante`](#representante) | 12 | — | interno | cliente |
...
| [`sprint_backlog_items`](#sprintbacklogitems) | 13 | — | sprint | estrutura_clusters, sprint_deliverables, projects, sprint_resumo, sprints, profiles |
| [`sprint_deliverables`](#sprintdeliverables) | 18 | — | sprint | profiles, sprint_deliverables, processes, projects, sprint_resumo, sprints |
| [`sprint_events`](#sprintevents) | 11 | — | sprint | sprint_resumo, sprints |
| [`sprint_metrics`](#sprintmetrics) | 9 | — | sprint | sprint_resumo, sprints |
...
| [`titularidade`](#titularidade) | 13 | — | cluster-cliente | bem, profiles, matricula, pessoa |
| [`tmpl_bloco`](#tmplbloco) | 23 | — | interno | profiles, tmpl_bloco, documento_gerado |
...
| [`tmpl_documento`](#tmpldocumento) | 10 | — | interno | profiles |
...
| [`wp_apresentacao`](#wpapresentacao) | 14 | excluido | interno | wp_importacao |
| [`wp_bem`](#wpbem) | 8 | — | interno | wp_importacao |
| [`wp_comentario`](#wpcomentario) | 7 | — | interno | wp_importacao |
| [`wp_divida`](#wpdivida) | 9 | — | interno | wp_importacao |
| [`wp_estudo`](#wpestudo) | 9 | excluido | interno | cliente, profiles, ordem_servico, org_projects |
| [`wp_farol`](#wpfarol) | 10 | — | interno | wp_importacao |
| [`wp_importacao`](#wpimportacao) | 20 | excluido | interno | wp_estudo, profiles |
| [`wp_valor`](#wpvalor) | 12 | — | interno | wp_importacao |
...
### <a id="acordoordempreferencia"></a>`acordo_ordem_preferencia`
**Acesso:** interno
`acordo_id` string · `created_at` string · `created_by` string? · `id` string · `ordem` number · `quem` string · `updated_at` string · `updated_by` string?  ·  **FK:** `acordo_id`→acordo_quotistas.id

### <a id="acordoquorum"></a>`acordo_quorum`
**Acesso:** interno
`acordo_id` string · `base` string · `chave` string? · `created_at` string · `created_by` string? · `id` string · `materia` string · `ordem` number · `percentual` number? · `tipo` string · `updated_at` string · `updated_by` string?  ·  **FK:** `acordo_id`→acordo_quotistas.id

### <a id="acordoquotistas"></a>`acordo_quotistas`
**Acesso:** interno · **Flags:** excluido
`assinado_em` string? · `camara_arbitral` string? · `cliente_id` string · `consolida_composse` boolean · `created_at` string · `created_by` string? · `data_referencia` string? · `excluido` boolean · `foro_eleito_comarca` string? · `foro_eleito_estado` string? · `grupos_conferidos` string[] · `id` string · `juros_valor_subscrito` string? · `mecanismos` string[]? · `metodos_avaliacao` string[]? · `nao_concorrencia` boolean · `nao_concorrencia_alcanca_parentes` boolean · `nao_concorrencia_area` string? · `nao_concorrencia_multa` string? · `nao_concorrencia_prazo_anos` number? · `objetos_preferencia` string[]? · `opcao_compra_preco` string? · `opcao_compra_prevista` boolean · `opcao_compra_quem` string? · `opcao_venda_prevista` boolean · `prazo_sigilo_anos` number? · `regime_nomeacao_arbitros` string? · `representante_pessoa_id` string? · `reuniao_previa_obrigatoria` boolean · `solucao_litigios` string? · `substituto_representante_pessoa_id` string? · `updated_at` string · `updated_by` string? · `versao` number · `vigencia_anos` number?  ·  **FK:** `cliente_id`→cliente.id · `representante_pessoa_id`→pessoa.id · `substituto_representante_pessoa_id`→pessoa.id

### <a id="acordoramofamiliar"></a>`acordo_ramo_familiar`
**Acesso:** interno
`acordo_id` string · `created_at` string · `created_by` string? · `id` string · `nome` string · `ordem` number · `updated_at` string · `updated_by` string?  ·  **FK:** `acordo_id`→acordo_quotistas.id

### <a id="acordosignatario"></a>`acordo_signatario`
**Acesso:** interno
`acordo_id` string · `created_at` string · `created_by` string? · `id` string · `ordem` number · `pessoa_id` string · `updated_at` string · `updated_by` string?  ·  **FK:** `acordo_id`→acordo_quotistas.id · `pessoa_id`→pessoa.id

### <a id="acordosociedaderelacionada"></a>`acordo_sociedade_relacionada`
**Acesso:** interno
`acordo_id` string · `created_at` string · `created_by` string? · `empresa_pessoa_id` string · `id` string · `ordem` number · `updated_at` string · `updated_by` string?  ·  **FK:** `acordo_id`→acordo_quotistas.id · `empresa_pessoa_id`→pessoa.id
...
### <a id="atividadegovernanca"></a>`atividade_governanca`
**Acesso:** interno · **Flags:** excluido
`cliente_id` string? · `created_at` string · `created_by` string? · `excluido` boolean · `id` string · `nome` string · `ordem` number · `updated_at` string · `updated_by` string?  ·  **FK:** `cliente_id`→cliente.id
...
**Acesso:** cluster-cliente
`cliente_id` string · `cliente_nome` string? · `criado_em` string? · `id` string · `periodo` string · `request_original` Json · `sincronizado_em` string? · `status` string · `uf` string · `usuario_id` string  ·  **FK:** `cliente_id`→cliente.id
...
**Acesso:** cluster-cliente
`created_at` string? · `id` string · `id_centro_custo` string · `id_ordem_servico` string · `percentual_rateio` number  ·  **FK:** `id_centro_custo`→centros_custo.id · `id_ordem_servico`→ordem_servico.id

### <a id="documentoarquivo"></a>`documento_arquivo`
**Acesso:** interno · **Flags:** ambiente, excluido
`ambiente` string · `area` Database["public"]["Enums"]["osg_doc_area"]? · `bem_id` string? · `categoria` Database["public"]["Enums"]["osg_doc_categoria"] · `checklist_item_id` string? · `checksum` string? · `cliente_id` string · `created_at` string · `created_by` string? · `documento_gerado_id` string? · `documento_tipo_id` string? · `excluido` boolean · `fonte` Database["public"]["Enums"]["osg_doc_fonte"] · `gcs_uri` string? · `id` string · `matricula_id` string? · `mime` string? · `nome_original` string · `pessoa_id` string? · `revisao` Database["public"]["Enums"]["osg_doc_revisao"] · `revisao_em` string? · `revisao_motivo` string? · `revisao_por` string? · `solicitacao_id` string? · `status` Database["public"]["Enums"]["osg_doc_status"] · `tamanho` number? · `triado_em` string? · `triado_por` string? · `updated_at` string · `updated_by` string?  ·  **FK:** `bem_id`→bem.id · `checklist_item_id`→checklist_cliente_item.id · `checklist_item_id`→cobertura_documentos_cliente.checklist_item_id · `cliente_id`→cliente.id · `documento_gerado_id`→documento_gerado.id · `documento_tipo_id`→documento_tipo.id · `matricula_id`→matricula.id · `pessoa_id`→pessoa.id · `revisao_por`→profiles.id · `solicitacao_id`→solicitacao.id

### <a id="documentodownload"></a>`documento_download`
**Acesso:** interno · **Flags:** ambiente
`acao` string · `ambiente` string · `baixado_em` string · `baixado_por` string · `cliente_id` string · `documento_id` string · `id` string · `papel` string  ·  **FK:** `cliente_id`→cliente.id · `documento_id`→documento_arquivo.id

### <a id="documentogerado"></a>`documento_gerado`
**Acesso:** interno
`acompanha_documento_id` string? · `caminho_arquivo` string? · `cliente_id` string · `created_at` string · `created_by` string? · `documento_anterior_id` string? · `documento_raiz_id` string? · `documento_template_id` string? · `gerado_em` string? · `gerado_por_id` string? · `id` string · `observacao` string? · `papel` string? · `pj_pessoa_id` string? · `snapshot_dados` Json? · `snapshot_flags` Json? · `snapshot_validado_em` string? · `snapshot_versoes_blocos` Json? · `status` string · `substitui_documento_id` string? · `updated_at` string · `updated_by` string?  ·  **FK:** `acompanha_documento_id`→documento_gerado.id · `cliente_id`→cliente.id · `created_by`→profiles.id · `documento_anterior_id`→documento_gerado.id · `documento_raiz_id`→documento_gerado.id · `documento_template_id`→tmpl_documento.id · `gerado_por_id`→profiles.id · `pj_pessoa_id`→pessoa.id · `substitui_documento_id`→documento_gerado.id · `updated_by`→profiles.id
...
### <a id="documentotipo"></a>`documento_tipo`
**Acesso:** interno
`ativo` boolean · `categoria` Database["public"]["Enums"]["osg_doc_categoria"]? · `categoria_docbox` string? · `cliente_id` string? · `codigo` string · `confidencial` boolean · `created_at` string · `created_by` string? · `documento` string · `entidade` string · `granularidade` string · `grupo` Database["public"]["Enums"]["osg_doc_grupo"] · `id` string · `modelo_bucket` string? · `modelo_nome` string? · `modelo_path` string? · `modulo` string · `nota` string? · `obrigatorio_default` boolean · `ordem` number · `solicitacao_item_id` string? · `updated_at` string · `updated_by` string?  ·  **FK:** `cliente_id`→cliente.id · `solicitacao_item_id`→solicitacao_item.id
...
**Acesso:** catalogo
`cluster_id` string · `color` string? · `color_index` number · `cost_center_id` string? · `created_at` string · `gestor_chamados_id` string? · `id` string · `is_active` boolean · `name` string · `page_categories` string[]? · `updated_at` string  ·  **FK:** `cluster_id`→estrutura_clusters.id · `cost_center_id`→centros_custo.id · `gestor_chamados_id`→profiles.id
...
**Acesso:** cluster-cliente
`cliente_id` string · `created_at` string · `created_by` string? · `culturas` string? · `data_assinatura` string? · `data_encerramento` string? · `data_inicio_vigencia` string? · `declarado_irpf` boolean · `documento_comprobatorio_id` string? · `estudo_fiscal_documento_id` string? · `id` string · `inclui_pecuaria` boolean · `indivisao_aviso_quantidade` number? · `indivisao_aviso_unidade` string? · `indivisao_prorrogavel` boolean? · `liquidacao_numero_parcelas` number? · `liquidacao_periodicidade` string? · `outorgante_capital_social_na_assinatura` number? · `outorgante_pessoa_id` string? · `pecuaria_modalidades` string[] · `percentual_explorador` number? · `percentual_outorgante` number? · `permite_penhor` boolean · `prazo_indivisao_quantidade` number? · `prazo_indivisao_unidade` string? · `referencia` string? · `regra_administracao` string? · `sacas_por_hectare` number? · `tipo_exploracao` Database["public"]["Enums"]["osg_tipo_exploracao"] · `updated_at` string · `updated_by` string? · `vigencia_prorrogavel` boolean  ·  **FK:** `cliente_id`→cliente.id · `documento_comprobatorio_id`→documento_arquivo.id · `estudo_fiscal_documento_id`→documento_arquivo.id · `outorgante_pessoa_id`→pessoa.id

### <a id="exploracaoruralimovel"></a>`exploracao_rural_imovel`
**Acesso:** interno
`area_explorada` number? · `area_unidade` string · `created_at` string · `created_by` string? · `exploracao_rural_id` string · `id` string · `matricula_id` string · `ordem` number · `origem_contraparte_pessoa_id` string? · `origem_exploracao_rural_id` string? · `origem_externa_id` string? · `origem_tipo` string? · `updated_at` string · `updated_by` string?  ·  **FK:** `exploracao_rural_id`→exploracao_rural.id · `matricula_id`→matricula.id · `origem_contraparte_pessoa_id`→pessoa.id · `origem_exploracao_rural_id`→exploracao_rural.id · `origem_externa_id`→exploracao_rural_origem_externa.id

### <a id="exploracaoruralorigemexterna"></a>`exploracao_rural_origem_externa`
**Acesso:** interno
`created_at` string · `created_by` string? · `data_assinatura` string? · `exploracao_rural_id` string · `id` string · `outorgante_capital_social_na_assinatura` number? · `outorgante_pessoa_id` string? · `outorgante_representante` string? · `titulo_instrumento` string? · `updated_at` string · `updated_by` string?  ·  **FK:** `exploracao_rural_id`→exploracao_rural.id · `outorgante_pessoa_id`→pessoa.id

### <a id="exploracaoruralparte"></a>`exploracao_rural_parte`
**Acesso:** interno
`created_at` string · `created_by` string? · `exploracao_rural_id` string · `fracao` number? · `id` string · `ordem` number · `papel` string · `pessoa_id` string · `updated_at` string · `updated_by` string?  ·  **FK:** `exploracao_rural_id`→exploracao_rural.id · `pessoa_id`→pessoa.id
...
**Acesso:** interno
`created_at` string · `donatario_pessoa_id` string · `id` string · `percentual` number · `quotas_atuais` number · `quotas_disponivel` number · `quotas_do_aporte` number · `quotas_final` number · `quotas_legitima` number · `simulacao_id` string · `vlr_aporte_moeda` number  ·  **FK:** `donatario_pessoa_id`→pessoa.id · `simulacao_id`→itcd_simulacao.id
...
**Acesso:** cluster-cliente
`area_documento` number · `area_explorada` number? · `area_real` number? · `area_unidade` string · `bem_id` string? · `cartorio_id` string · `cliente_id` string? · `confrontacoes_texto` string? · `created_at` string · `created_by` string? · `data_matricula` string? · `descricao_psa_completa` string? · `folha` string? · `georref_prejudica_transferencia` boolean? · `georreferenciado` string? · `id` string · `imposto_anual_exercicio` number? · `livro` string? · `matricula_anterior_id` string? · `matricula_anterior_texto` string? · `municipio_imovel` string · `numero` string · `origem_descricao` string? · `tipo_bem` string? · `tipo_exploracao_posse` string? · `uf_imovel` string · `updated_at` string · `updated_by` string? · `vlr_benfeitorias` number? · `vlr_contabil` number? · `vlr_contabil_ajustado` number? · `vlr_imposto_anual` number? · `vlr_mercado` number?  ·  **FK:** `bem_id`→bem.id · `cartorio_id`→cartorio.id · `cliente_id`→cliente.id · `created_by`→profiles.id · `matricula_anterior_id`→matricula.id · `updated_by`→profiles.id

### <a id="matrizalcadas"></a>`matriz_alcadas`
**Acesso:** interno · **Flags:** excluido
`cliente_id` string · `created_at` string · `created_by` string? · `data_referencia` string? · `excluido` boolean · `id` string · `updated_at` string · `updated_by` string? · `versao` number  ·  **FK:** `cliente_id`→cliente.id

### <a id="matrizatividade"></a>`matriz_atividade`
**Acesso:** interno
`atividade_id` string · `created_at` string · `created_by` string? · `detalhamento` string? · `id` string · `matriz_id` string · `ordem` number · `updated_at` string · `updated_by` string?  ·  **FK:** `atividade_id`→atividade_governanca.id · `matriz_id`→matriz_alcadas.id

### <a id="matrizcompetencia"></a>`matriz_competencia`
**Acesso:** interno
`alcada_base` string? · `alcada_unidade` string? · `alcada_valor` number? · `created_at` string · `created_by` string? · `fora_da_politica` boolean · `id` string · `matriz_atividade_id` string · `nao_participa` boolean · `orgao_id` string · `sobe_para_orgao_id` string? · `updated_at` string · `updated_by` string?  ·  **FK:** `matriz_atividade_id`→matriz_atividade.id · `orgao_id`→orgao_governanca.id · `sobe_para_orgao_id`→orgao_governanca.id

### <a id="matrizcompetenciapapel"></a>`matriz_competencia_papel`
**Acesso:** interno
`competencia_id` string · `created_at` string · `created_by` string? · `ordem` number · `papel_id` string  ·  **FK:** `competencia_id`→matriz_competencia.id · `papel_id`→papel_governanca.id
...
**Acesso:** interno
`comment_id` string · `created_at` string · `id` string · `lido_em` string? · `mentioned_user_id` string · `motivo` string  ·  **FK:** `comment_id`→org_comments.id · `comment_id`→org_comments_feed.id · `mentioned_user_id`→profiles.id
...
### <a id="orgfeedvisto"></a>`org_feed_visto`
**Acesso:** interno
`client_id` string · `user_id` string · `visto_ate` string  ·  **FK:** `user_id`→profiles.id
...
**Acesso:** interno · **Flags:** excluido
`cargos_do_orgao` string[]? · `cliente_id` string · `created_at` string · `created_by` string? · `entra_no_contrato` boolean · `excluido` boolean · `genero` string? · `id` string · `mandato_anos` number? · `membros_maximo` number? · `membros_minimo` number? · `nome` string · `ordem` number · `padrao_chave` string? · `updated_at` string · `updated_by` string? · `vigencia_fim` string? · `vigencia_inicio` string?  ·  **FK:** `cliente_id`→cliente.id
...
### <a id="papelgovernanca"></a>`papel_governanca`
**Acesso:** interno · **Flags:** excluido
`cliente_id` string? · `created_at` string · `created_by` string? · `excluido` boolean · `grupo` string? · `id` string · `infinitivo` string? · `nome` string · `ordem` number · `updated_at` string · `updated_by` string?  ·  **FK:** `cliente_id`→cliente.id
...
### <a id="produtodocumentotipo"></a>`produto_documento_tipo`
**Acesso:** interno
`created_at` string · `created_by` string? · `id` string · `item_padrao_id` string · `obrigatorio` boolean · `produto_segmento_id` string · `updated_at` string · `updated_by` string?  ·  **FK:** `item_padrao_id`→documento_tipo.id · `produto_segmento_id`→produto_segmento.id

### <a id="produtosegmento"></a>`produto_segmento`
**Acesso:** catalogo
`cluster_id` string? · `codigo` string · `created_at` string? · `id` string · `is_active` boolean? · `is_canal_chamados` boolean · `nome` string  ·  **FK:** `cluster_id`→estrutura_clusters.id
...
### <a id="produtotarefapadrao"></a>`produto_tarefa_padrao`
**Acesso:** interno
`ativo` boolean · `created_at` string · `created_by` string? · `descricao` string? · `dias_offset` number · `horas_estimadas` number? · `id` string · `ordem` number · `papel_responsavel` string · `produto_segmento_id` string · `titulo` string · `updated_at` string · `updated_by` string?  ·  **FK:** `produto_segmento_id`→produto_segmento.id
...
**Acesso:** interno
`category` string? · `created_at` string? · `description` string? · `file_name` string · `file_path` string · `file_size` number? · `file_type` string? · `id` string · `process_id` string? · `sprint_id` string? · `title` string · `updated_at` string? · `uploaded_by` string?  ·  **FK:** `process_id`→processes.id · `sprint_id`→sprint_resumo.sprint_id · `sprint_id`→sprints.id · `uploaded_by`→profiles.id
...
### <a id="protocolobeneficiario"></a>`protocolo_beneficiario`
**Acesso:** interno · **Flags:** excluido
`created_at` string · `created_by` string? · `excluido` boolean · `id` string · `nome` string · `ordem` number · `protocolo_id` string? · `updated_at` string · `updated_by` string?  ·  **FK:** `protocolo_id`→protocolo_remuneracao.id

### <a id="protocoloitemgovernanca"></a>`protocolo_item_governanca`
**Acesso:** interno · **Flags:** excluido
`cliente_id` string? · `created_at` string · `created_by` string? · `excluido` boolean · `id` string · `nome` string · `ordem` number · `tema_id` string · `updated_at` string · `updated_by` string?  ·  **FK:** `cliente_id`→cliente.id · `tema_id`→protocolo_tema_governanca.id

### <a id="protocololinha"></a>`protocolo_linha`
**Acesso:** interno
`created_at` string · `created_by` string? · `id` string · `item_id` string · `ordem` number · `protocolo_id` string · `updated_at` string · `updated_by` string?  ·  **FK:** `item_id`→protocolo_item_governanca.id · `protocolo_id`→protocolo_remuneracao.id

### <a id="protocoloregra"></a>`protocolo_regra`
**Acesso:** interno
`beneficiario_id` string · `created_at` string · `created_by` string? · `id` string · `linha_id` string · `texto` string · `updated_at` string · `updated_by` string?  ·  **FK:** `beneficiario_id`→protocolo_beneficiario.id · `linha_id`→protocolo_linha.id

### <a id="protocoloremuneracao"></a>`protocolo_remuneracao`
**Acesso:** interno · **Flags:** excluido
`cliente_id` string · `created_at` string · `created_by` string? · `excluido` boolean · `id` string · `preambulo` string? · `updated_at` string · `updated_by` string? · `versao` number  ·  **FK:** `cliente_id`→cliente.id

### <a id="protocolotemagovernanca"></a>`protocolo_tema_governanca`
**Acesso:** interno · **Flags:** excluido
`cliente_id` string? · `created_at` string · `created_by` string? · `excluido` boolean · `id` string · `nome` string · `ordem` number · `updated_at` string · `updated_by` string?  ·  **FK:** `cliente_id`→cliente.id

### <a id="psamigrationsaplicadas"></a>`psa_migrations_aplicadas`
**Acesso:** interno
`aplicada_em` string · `arquivo` string · `autor` string? · `branch` string? · `commit_sha` string? · `sha256` string
...
**Acesso:** interno
`acesso_chamados` boolean? · `cargo` string? · `created_at` string? · `email` string? · `id_cliente` string · `id_representante` string · `nome` string · `observacoes` string? · `telefone` string? · `tipo_representante` string? · `updated_at` string? · `user_id` string?  ·  **FK:** `id_cliente`→cliente.id
...
### <a id="solicitacao"></a>`solicitacao`
**Acesso:** interno
`cliente_id` string · `created_at` string · `created_by` string? · `encerrada_em` string? · `enviada_em` string? · `id` string · `observacao` string? · `ordem_servico_id` string? · `status` Database["public"]["Enums"]["osg_solicitacao_status"] · `updated_at` string · `updated_by` string?  ·  **FK:** `cliente_id`→cliente.id · `ordem_servico_id`→ordem_servico.id

### <a id="solicitacaoitem"></a>`solicitacao_item`
**Acesso:** interno
...
**Acesso:** sprint
`cluster_id` string? · `created_at` string? · `description` string? · `estimated_hours` number? · `id` string · `moved_to_deliverable_id` string? · `priority` string? · `project_id` string? · `sprint_id` string? · `status` string? · `suggested_by` string? · `title` string · `updated_at` string?  ·  **FK:** `cluster_id`→estrutura_clusters.id · `moved_to_deliverable_id`→sprint_deliverables.id · `project_id`→projects.id · `sprint_id`→sprint_resumo.sprint_id · `sprint_id`→sprints.id · `suggested_by`→profiles.id

### <a id="sprintdeliverables"></a>`sprint_deliverables`
**Acesso:** sprint
`actual_hours` number? · `assigned_to` string? · `completed_at` string? · `created_at` string? · `description` string? · `due_date` string · `estimated_hours` number? · `id` string · `parent_id` string? · `process_id` string? · `project_id` string? · `retrospective_report` string? · `sprint_id` string? · `start_date` string? · `status` string? · `task_code` string? · `title` string · `updated_at` string?  ·  **FK:** `assigned_to`→profiles.id · `parent_id`→sprint_deliverables.id · `process_id`→processes.id · `project_id`→projects.id · `sprint_id`→sprint_resumo.sprint_id · `sprint_id`→sprints.id

### <a id="sprintevents"></a>`sprint_events`
**Acesso:** sprint
`created_at` string? · `description` string? · `end_time` string? · `event_date` string · `event_type` string? · `id` string · `location` string? · `participants` string[]? · `sprint_id` string? · `start_time` string? · `title` string  ·  **FK:** `sprint_id`→sprint_resumo.sprint_id · `sprint_id`→sprints.id

### <a id="sprintmetrics"></a>`sprint_metrics`
**Acesso:** sprint
`category` string? · `created_at` string? · `current_value` number? · `id` string · `name` string · `sprint_id` string? · `target_value` number? · `unit` string? · `updated_at` string?  ·  **FK:** `sprint_id`→sprint_resumo.sprint_id · `sprint_id`→sprints.id
...
**Acesso:** cluster-cliente
`bem_id` string? · `created_at` string · `created_by` string? · `fracao` number? · `id` string · `integralizador` boolean · `matricula_id` string? · `tipo` string · `titular_pessoa_id` string · `updated_at` string · `updated_by` string? · `vlr_contabil` number? · `vlr_integralizar` number?  ·  **FK:** `bem_id`→bem.id · `created_by`→profiles.id · `matricula_id`→matricula.id · `titular_pessoa_id`→pessoa.id · `updated_by`→profiles.id

### <a id="tmplbloco"></a>`tmpl_bloco`
**Acesso:** interno
`ancora` string? · `ativo` boolean · `autor_id` string? · `bloco_origem_id` string? · `categoria` string? · `created_at` string · `created_by` string? · `descricao` string? · `escopo_documento_raiz_id` string? · `familia_id` string? · `id` string · `nome` string · `quebra_pagina_antes` boolean · `reinicia_numeracao` boolean · `repete_colecao` string? · `tipo` string · `tipo_derivacao` string? · `titulo_documento` string? · `updated_at` string · `updated_by` string? · `variante_ordem` number? · `variante_rotulo` string? · `variante_seletor` Json?  ·  **FK:** `autor_id`→profiles.id · `bloco_origem_id`→tmpl_bloco.id · `created_by`→profiles.id · `escopo_documento_raiz_id`→documento_gerado.id · `familia_id`→tmpl_bloco.id · `updated_by`→profiles.id
...
**Acesso:** interno
`ativo` boolean · `created_at` string · `created_by` string? · `descricao` string? · `escopo` string · `id` string · `nome` string · `tipo` string? · `updated_at` string · `updated_by` string?  ·  **FK:** `created_by`→profiles.id · `updated_by`→profiles.id
...
### <a id="wpapresentacao"></a>`wp_apresentacao`
**Acesso:** interno · **Flags:** excluido
`checksum` string? · `created_at` string · `excluido` boolean · `gerado_por` string? · `id` string · `importacao_id` string · `nome_arquivo` string · `problemas` Json · `storage_path` string · `tamanho` number? · `template_checksum` string? · `template_nome` string · `versao` number · `versao_do_gerador` string  ·  **FK:** `importacao_id`→wp_importacao.id

### <a id="wpbem"></a>`wp_bem`
**Acesso:** interno
`categoria` string · `contribuinte` string? · `descricao` string? · `id` string · `importacao_id` string · `ordem` number · `origem_linha` string · `valor` number?  ·  **FK:** `importacao_id`→wp_importacao.id

### <a id="wpcomentario"></a>`wp_comentario`
**Acesso:** interno
`cenario` string? · `id` string · `importacao_id` string · `ordem` number · `origem_celula` string · `texto` string · `tributo` string  ·  **FK:** `importacao_id`→wp_importacao.id

### <a id="wpdivida"></a>`wp_divida`
**Acesso:** interno
`id` string · `importacao_id` string · `instituicao` string? · `ordem` number · `origem_linha` string · `por_ano` Json · `saldo_devedor` number? · `titularidade` string · `vencimento_final` string?  ·  **FK:** `importacao_id`→wp_importacao.id

### <a id="wpestudo"></a>`wp_estudo`
**Acesso:** interno · **Flags:** excluido
`cliente_id` string · `created_at` string · `criado_por` string? · `descricao` string? · `excluido` boolean · `id` string · `ordem_servico_id` string · `projeto_id` string? · `updated_at` string  ·  **FK:** `cliente_id`→cliente.id · `criado_por`→profiles.id · `ordem_servico_id`→ordem_servico.id · `projeto_id`→org_projects.id

### <a id="wpfarol"></a>`wp_farol`
**Acesso:** interno
`bloco` string · `id` string · `importacao_id` string · `origem_celula` string · `pessoa` Database["public"]["Enums"]["wp_pessoa"] · `regime` Database["public"]["Enums"]["wp_regime"] · `rotulo` string · `unidade` Database["public"]["Enums"]["wp_unidade"] · `valor_numerico` number? · `valor_texto` string?  ·  **FK:** `importacao_id`→wp_importacao.id

### <a id="wpimportacao"></a>`wp_importacao`
**Acesso:** interno · **Flags:** excluido
`ano_base` number? · `ano_final` number? · `ano_inicial` number? · `checksum` string · `cliente_no_wp` string? · `created_at` string · `crescimento_anual` number? · `estudo_id` string · `excluido` boolean · `gcs_uri` string? · `id` string · `importado_por` string? · `mime` string? · `nome_original` string? · `preparado_por_wp` string? · `problemas` Json · `revisado_por_wp` string? · `tamanho` number? · `versao` number · `versao_do_mapa` string  ·  **FK:** `estudo_id`→wp_estudo.id · `importado_por`→profiles.id

### <a id="wpvalor"></a>`wp_valor`
**Acesso:** interno
`ano` number · `bloco` Database["public"]["Enums"]["wp_bloco"] · `cenario` string · `contribuinte` string? · `id` string · `importacao_id` string · `nivel` number? · `origem_celula` string · `rotulo` string · `unidade` Database["public"]["Enums"]["wp_unidade"] · `valor_numerico` number? · `valor_texto` string?  ·  **FK:** `importacao_id`→wp_importacao.id

---

## Enums

- `app_role`: admin, client, team_member, lider, sublider, timecliente, marketing
...
- `notificacao_tipo`: tarefa_atribuida, tarefa_em_revisao, documento_recebido, solicitacao_enviada, documento_aprovado, documento_recusado, cobranca_pendencia, chamado_criado, chamado_atribuido, chamado_respondido, chamado_vencido, chamado_resolvido, solicitacao_vencida, tarefa_prazo_proximo, tarefa_atrasada, papel_de_trabalho_importado, tarefa_inativa, projeto_inativo
- `org_comment_entity`: org_task, org_project
- `org_comment_kind`: comment, assignment_changed, review_submitted, review_approved, review_adjustments, status_changed, documentos_solicitados, documentos_cobrados, documentos_conferidos, papel_de_trabalho_importado, papel_de_trabalho_revisado
...
- `osg_doc_categoria`: bens_direitos, cadastros_fiscais, declaracao_ir, agrarios, pessoais, societarios, sucessorios, outros, georreferenciamento, proposta_comercial
...
- `osg_solicitacao_status`: rascunho, enviada, em_checklist, encerrada
...
- `wp_bloco`: resumo, dre, apuracao, farol, imoveis, bens, dividas
- `wp_pessoa`: pf, pj
