...
| | Antes | Depois |
|---|---|---|
| Ordem da decisão | contexto primeiro, marco por último | **marco primeiro**, contexto depois, com o corpo montado em duas partes independentes |
...
fica **"Tarefa atrasada"**. Em `src/lib/notificacoesInternas.ts`. O teste foi atrás em
`0b6e3ed1`, que era o que estava quebrando a CI da main, com o motivo escrito ao lado da
asserção para ninguém "consertar" de volta o rótulo que a redação escolheu.
