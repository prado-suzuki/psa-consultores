...
| [Cadastro · 7 Mensagens de recusa](TAREFA_mensagens-de-recusa.md) | Uma tradução só para as recusas (hoje o funil decide por um teste de palavras **em inglês**, e rebaixa toda mensagem em português). Fecha as operações que recusam em silêncio e terminam em "sucesso". | Não — só código | Plano escrito · **texto das mensagens fechado** (02/09) · 3 decisões abertas (D1–D3) |
